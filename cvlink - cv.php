        ...
        <div class="content">
                ...
                <div  class="input-text">
                    <div class="square_invite-div">
                        <div class="square-invite-ajax">
                            <button> <span>Interview Invitation Template 1</span> </button>
                        </div>
                        <div class="square-invite-ajax">
                            <button> <span >Interview Invitation Template 2</span> </button>
                        </div>
                        <div class="square-invite-ajax">
                            <button> <span >Interview Invitation Template 3</span> </button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="reject-full">
                ...
                <div  class="input-text">
                    ...
                    <textarea id="invite-textarea"  placeholder="Enter details for your selections"></textarea>
