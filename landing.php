        ...
        <div class="container">
            ...
            <div>
                <div class="row landing-row">
                    ...
                    <div id="insign" class="col-xl-6" style="">
                                    ...
                                    <div class="example">
                                        <label class="checkbox-button">
                                            ...
                                            <span class="checkbox-button__label"
                                                  style="color:  #131031;">I agree to  <span class="terms"> mycvlink terms</span></span>
                                        </label>
                                    </div>

                                    <a href="Home.php">
                                        <button class="your-cvlink">Sign up & Get your cvlink</button>
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div id="mission-row" style="padding-top:140px;padding-bottom: 30px;">
                ...
                <div class="row landing-row">
                    <div class="col-lg-4 account_people">
